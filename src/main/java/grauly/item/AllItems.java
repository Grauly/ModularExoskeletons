...
public class AllItems implements RegistryHelper {
    ...
    public static final Item EXO_HELMET = new ExoArmorItem(EXO_MATERIAL, EquipmentSlot.HEAD, settings);
    public static final Item EXO_CHESTPLATE = new ExoArmorItem(EXO_MATERIAL, EquipmentSlot.CHEST, settings);
    public static final Item EXO_LEGGING = new ExoArmorItem(EXO_MATERIAL, EquipmentSlot.LEGS, settings);
    public static final Item EXO_BOOTS = new ExoArmorItem(EXO_MATERIAL, EquipmentSlot.FEET, settings);
